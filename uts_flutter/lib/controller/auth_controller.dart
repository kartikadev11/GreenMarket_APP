...
import 'package:uts_flutter/service/local_service/local_auth_service.dart';
import 'package:uts_flutter/service/remote_service/remote_auth_service.dart';
    ...
    try {
      ...
      if (result.statusCode == 200) {
        ...
        if (userResult.statusCode == 200) {
          ...
          EasyLoading.showSuccess("Welcome to Green Mart!");
